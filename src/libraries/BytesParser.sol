...
library BytesParser {
	...
	function parseAssetPair(
		bytes calldata params
	) internal pure returns (address base, address quote, bytes calldata data) {
		assembly ("memory-safe") {
	...
	function parseFeedParams(
		bytes calldata params
	) internal pure returns (address feed, address base, address quote, bytes calldata data) {
		assembly ("memory-safe") {
